...
try:
    ...
    def create_mcp_http_client(  # type: ignore[misc]
...
class MCPClient:
    ...
    def generate_function_from_mcp_tool(
        ...
        parameters_schema = mcp_tool.inputSchema.get("properties", {})  # type: ignore[attr-defined]
        required_params = mcp_tool.inputSchema.get("required", [])  # type: ignore[attr-defined]
    ...
    def _build_tool_schema(self, mcp_tool: types.Tool) -> dict[str, Any]:
        ...
        input_schema = mcp_tool.inputSchema  # type: ignore[attr-defined]
